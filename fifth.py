...
def print_file_type(file_name):
    ...
    elif is_gif1(file_name) or is_gif2(file_name):
...
if __name__ == '__main__':
    try:
        if len(sys.argv) > 1:
            ...
            file_name = input("Zadej cestu k souboru: ")
            # možnost zadat cestu k souboru ručně
